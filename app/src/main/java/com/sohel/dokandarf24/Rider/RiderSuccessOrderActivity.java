...
public class RiderSuccessOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rider_success_order);
        ...
        orderAdapter.setOnItemClickListner(new OrderListAdapter.OnItemClickListner() {
            ...
            public void onItemClick(int position) {
                ...
                Intent intent=new Intent(RiderSuccessOrderActivity.this, OrderStateActivity.class);
            ...
            public void onDelete(int position) {
                Toast.makeText(RiderSuccessOrderActivity.this, "No Permission", Toast.LENGTH_SHORT).show();
            }
        });
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.exists()){
                            ...
                            for(DataSnapshot snapshot1:snapshot.getChildren()){
                                ...
                                if(orderModel.getPickedRiderId().equals(userDb.getRiderPhone()) &&  orderModel.getOrderState().equals(OrderState.step5)){
                            ...
                            Toast.makeText(RiderSuccessOrderActivity.this, "No Success Order Found", Toast.LENGTH_SHORT).show();
                            progressDialog.dismiss();
                        }
                    }
