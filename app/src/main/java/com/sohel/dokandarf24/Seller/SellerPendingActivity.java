...
import com.sohel.dokandarf24.User.UPendingActivity;

import java.util.ArrayList;
import java.util.List;

public class SellerPendingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seller_pending);
        ...
        orderAdapter.setOnItemClickListner(new OrderListAdapter.OnItemClickListner() {
            ...
            public void onItemClick(int position) {
                ...
                Intent intent=new Intent(SellerPendingActivity.this, OrderStateActivity.class);
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.exists()){
                            ...
                            for(DataSnapshot snapshot1:snapshot.getChildren()){
                                ...
                                if(orderModel.getPickedSellerId().equals(userDb.getSellerPhone()) && !orderModel.getOrderState().equals(OrderState.step1) && !orderModel.getOrderState().equals(OrderState.step5)){
                            ...
                            Toast.makeText(SellerPendingActivity.this, "No Pending Order Found", Toast.LENGTH_SHORT).show();
                            progressDialog.dismiss();
                        }
                    }
