...
public class UPendingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_u_pending);
        init();
        ...
        orderAdapter.setOnItemClickListner(new OrderListAdapter.OnItemClickListner() {
            ...
            public void onItemClick(int position) {
                ...
                Intent intent=new Intent(UPendingActivity.this,OrderStateActivity.class);
            ...
            public void onDelete(int position) {
                Toast.makeText(UPendingActivity.this, "Order Delete Failed", Toast.LENGTH_SHORT).show();
            }
        });
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.exists()){
                            ...
                            for(DataSnapshot snapshot1:snapshot.getChildren()){
                                ...
                                if(orderModel.getUserId().equals(userDb.getUserPhone()) && !orderModel.getOrderState().equals(OrderState.step1) && !orderModel.getOrderState().equals(OrderState.step5)){
                            ...
                            Toast.makeText(UPendingActivity.this, "No Pending Order Found", Toast.LENGTH_SHORT).show();
                            progressDialog.dismiss();
                        }
                    }
