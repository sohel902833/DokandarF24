...
public class USuccessActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_u_success);
        init();
        ...
        orderAdapter.setOnItemClickListner(new OrderListAdapter.OnItemClickListner() {
            ...
            public void onItemClick(int position) {
                ...
                Intent intent=new Intent(USuccessActivity.this,OrderStateActivity.class);
                intent.putExtra("orderId",orderModel.getOrderId());
                startActivity(intent);
            }
            @Override
            public void onDelete(int position) {
                Toast.makeText(USuccessActivity.this, "Order Delete Failed", Toast.LENGTH_SHORT).show();
            }
        });
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.exists()){
                            ...
                            for(DataSnapshot snapshot1:snapshot.getChildren()){
                                ...
                                if(orderModel.getUserId().equals(userDb.getUserPhone()) &&  orderModel.getOrderState().equals(OrderState.step5)){
                            ...
                            Toast.makeText(USuccessActivity.this, "No Success Order Found", Toast.LENGTH_SHORT).show();
                            progressDialog.dismiss();
                        }
                    }
